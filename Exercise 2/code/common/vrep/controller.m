...
% Pioneer_p3dx_setTargetGhostPose(connection, -0.5, 0, deg2rad(180));
Pioneer_p3dx_setTargetGhostPose(connection, 3, 0.5, deg2rad(180));
...
parameters.dist_threshold= 0.1; % threshold distance to goal
parameters.angle_threshold = deg2rad(5);%0.4; % threshold orientation to goal
...
while (~EndCond)
    ...
    fprintf('Robot: %0.2g, %0.2g, %0.2g | Ghost: %0.2g, %0.2g, %0.2g\n', x, y, theta, xg, yg, thetag)
